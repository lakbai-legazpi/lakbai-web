...
export default function NewJourneyModal({
  ...
  const dateSummary = formatDateSelection(timingData.startDate, timingData.endDate);
  const flexibleSummary = formatFlexibleSelection(timingData.flexibleDays, sortedFlexibleMonths);
                  ...
                  >
                    <span
                      className={cn(
                        ...
                        timingData.selectedTimingType === 'flexible' && 'font-bold'
                      )}
                    >
