          ...
          <button
            onClick={() => {
              ...
              const updatedData: TimingData = {
                ...
                startDate: newTimingType === 'dates' ? startDate : '',
                endDate: newTimingType === 'dates' ? endDate : '',
                flexibleDays: newTimingType === 'flexible' ? flexibleDays : 5,
                flexibleMonths: newTimingType === 'flexible' ? flexibleMonths : []
              };
